...
!function($) {
    ...
    MainApp.prototype.showLoader = function (delay=350) {
        $('#status').fadeIn();
        $('#preloader').delay(delay).fadeIn('slow');
        $('body').delay(delay).css({
            'overflow': 'visible'
        });
    },
    MainApp.prototype.hideLoader = function (delay=350) {
        $('#status').fadeOut();
    ...
    MainApp.prototype.initTooltip = function () {
        $('[data-toggle="tooltip"]').tooltip();
    },
