    ...
    <div style="background: #282923;color: #FFF;" class="p-2 pr-4 mb-2 mr-3 float-left rounded">
        ...
        <div class="p-2 ml-4 rounded" style="background: #30312a;">
            <table>
                ...
                <tr>@include('managerl::models.relations.option', ['option' => 'farParent'])</tr>
                <tr>@include('managerl::models.relations.option', ['option' => 'throughParent'])</tr>
                <tr>@include('managerl::models.relations.option', ['option' => 'related'])</tr>
                <tr>@include('managerl::models.relations.option', ['option' => 'localKey'])</tr>
                <tr>@include('managerl::models.relations.option', ['option' => 'firstKey'])</tr>
                <tr>@include('managerl::models.relations.option', ['option' => 'secondKey'])</tr>
                <tr>@include('managerl::models.relations.option', ['option' => 'secondLocalKey'])</tr>
            </table>
        </div>
        <span>}</span>
    </div>
