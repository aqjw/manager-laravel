    ...
    <div style="background: #282923;color: #FFF;" class="p-2 pr-4 mb-2 mr-3 float-left rounded">
        ...
        <div class="p-2 ml-4 rounded" style="background: #30312a;">
            <table>
                ...
                <tr>@include('managerl::models.relations.option', ['option' => 'morphClass'])</tr>
                <tr>@include('managerl::models.relations.option', ['option' => 'related'])</tr>
                <tr>@include('managerl::models.relations.option', ['option' => 'foreignPivotKey'])</tr>
                <tr>@include('managerl::models.relations.option', ['option' => 'relatedPivotKey'])</tr>
                <tr>@include('managerl::models.relations.option', ['option' => 'parentKey'])</tr>
                <tr>@include('managerl::models.relations.option', ['option' => 'relatedKey'])</tr>
                <tr>@include('managerl::models.relations.option', ['option' => 'morphType'])</tr>
            </table>
        </div>
        <span>}</span>
    </div>
